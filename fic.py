...
###################################################################
'''
     Spyder is always watching , Be alert World!
'''
###################################################################
#                             COLOR
...
def baliho():
	try:
		...
		print ' ' + W
		print ('F I C').center(44)
		print (W + '     [' + G +'Facebook Information Catcher'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Spyder
    Name       F I C 'Facebook Information Catcher'
    CodeName   FBDoc
    version    full version
    Date       07/03/2020 05:40
    E-Mail     devil001anonymous@gmail.com
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'FBDoc' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'FBDoc' + W +'/' + R +'Bot ' + W + '>> ')
